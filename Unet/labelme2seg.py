...
def json2png(json_folder, png_save_folder):
    ...
    for json_file in json_files:
        ...
        label_path = osp.join(json_folder, json_file.split(".")[0] + "_json/label.png")#1111
        png_save_path = osp.join(png_save_folder, json_file.split(".")[0] + ".png")
        label_png = cv2.imread(label_path, 0)#1111
...
if __name__ == '__main__':
    ...
    json2png(json_folder="C:/Users/successful/Desktop/ttyss/label/", png_save_folder="C:/Users/successful/Desktop/ttyss/image/")
